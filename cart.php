                               ...
                               ?>
                                   ...
                                   <tr><!-- tr Begin -->
                                       ...
                                       <td>
                                           ...
                                           <img class="img-responsive" src="admin_area/product_images/<?php echo $product_img1; ?>" alt="product 2">
                                           
                                       </td>
                                       
                                       <td>
                                           
                                           <a href="default.php?pro_id=<?php echo $pro_id; ?>"><?php echo $product_title; ?></a>
                       ...
                       <div class='product same-height'><!-- product same-height Begin -->
                           <a href='default.php?pro_id=$pro_id'>
                            ...
                            <div class='text'><!-- text Begin -->
                                <h3><a href='default.php?pro_id=$pro_id'>$pro_title</a></h3>
                                
                                <p class='price'>Rs $pro_price.00</p>
