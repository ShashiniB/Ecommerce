...
$db = mysqli_connect("localhost","root","","solo_fashion");
...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            echo "<script>window.open('default.php?pro_id=$p_id','_self')</script>";
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        <div class='col-md-4 col-sm-6 single'>
            ...
            <div class='product'>
                ...
                <a href='default.php?pro_id=$pro_id'>
                ...
                <div class='text'>
                    ...
                    <p class='button'>
                        ...
                        <a class='btn btn-default' href='default.php?pro_id=$pro_id'>

                            View Details

                        </a>
                    
                        <a class='btn btn-primary' href='default.php?pro_id=$pro_id'>
                    ...
                    <div class='product'>
                        ...
                        <div class='text'>
                            ...
                            <h3>
                                ...
                                <a href='default.php?pro_id=$pro_id'> $pro_title </a>
